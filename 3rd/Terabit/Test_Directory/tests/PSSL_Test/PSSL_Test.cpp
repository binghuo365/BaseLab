...
template class ACE_Asynch_Acceptor2<PSession>;
template class ACE_Asynch_Connector2<PSession>;
...
#pragma instantiate ACE_Asynch_Acceptor2<PSession>
#pragma instantiate ACE_Asynch_Connector2<PSession>
...
Receiver::Receiver ()
: PSession         ()
, stream_          (ACE_SSL_Asynch_Stream::ST_SERVER, 0)
, flg_cancel_      (false)
...
Sender::Sender ()
: PSession         ()
, stream_          (ACE_SSL_Asynch_Stream::ST_CLIENT, 0)
, flg_cancel_      (false)
, flg_safe_delete_ (false)
{
}
