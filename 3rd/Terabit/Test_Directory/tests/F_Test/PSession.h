...
class PSession : public ACE_Service_Handler
{
...
protected:
  ...
  void trace_write_completion (const ACE_Asynch_Write_Stream::Result &result,
                               const char *type);
  void trace_transmit_completion (const ACE_Asynch_Transmit_File::Result &result);
...
// 
//---------------------------------------------------------------------------
class Acceptor :  public ACE_Asynch_Acceptor<PSession>
{
public:
...
// 
//---------------------------------------------------------------------------
class Connector : public ACE_Asynch_Connector<PSession>
{
public:
