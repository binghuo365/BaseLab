...
void
PConnection::addresses (const ACE_INET_Addr& peer, const ACE_INET_Addr& local)
{
...
Acceptor::start(const ACE_INET_Addr & addr)
{
  ...
  int rc = this->open(addr,
                    ...
                    1,   //int reuse_addr = 1,
                    manager().task().get_proactor(0), // ACE_Proactor *proactor = 0,
...
template class ACE_Asynch_Acceptor2<PConnection>;
template class ACE_Asynch_Connector2<PConnection>;

#elif defined (ACE_HAS_TEMPLATE_INSTANTIATION_PRAGMA)

#pragma instantiate ACE_Asynch_Acceptor2<PConnection>
#pragma instantiate ACE_Asynch_Connector2<PConnection>
