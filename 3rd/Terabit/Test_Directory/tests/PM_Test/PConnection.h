...
// 
//---------------------------------------------------------------------------
class PConnectionManager : public ACE_Handler
{
...
class PConnection : public ACE_Service_Handler
{
...
// 
//---------------------------------------------------------------------------
class Acceptor :  public ACE_Asynch_Acceptor2<PConnection>
{
public:
...
// 
//---------------------------------------------------------------------------
class Connector : public ACE_Asynch_Connector2<PConnection>
{
public:
