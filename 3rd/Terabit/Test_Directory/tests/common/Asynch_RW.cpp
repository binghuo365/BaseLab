...
ACE_Asynch_RW_T<READER, WRITER>::ACE_Asynch_RW_T (void)
...
ACE_Asynch_RW_T<READER, WRITER>::close(void)
{
...
template <class READER, class WRITER> int
ACE_Asynch_RW_T<READER, WRITER>::cancel(void)
{
...
template <class READER, class WRITER> int
ACE_Asynch_RW_T<READER, WRITER>::cancel_and_close(void)
{
  this->cancel();
  return this->close();
}
...
template <class READER, class WRITER> int
ACE_Asynch_RW_T<READER, WRITER>::open 
         (ACE_Handler &handler,
          ACE_HANDLE handle, 
...
template <class READER, class WRITER> int
ACE_Asynch_RW_Stream_T<READER, WRITER>::read (const Buffer_Info& buf_info,
...
template <class READER, class WRITER> int
ACE_Asynch_RW_Stream_T<READER, WRITER>::write (const Buffer_Info& buf_info,
...
ACE_Asynch_RW_Dgram_T<READER, WRITER>::recv (const Buffer_Info& buf_info,  
...
template <class READER, class WRITER> ssize_t
ACE_Asynch_RW_Dgram_T<READER, WRITER>::send  (const Buffer_Info& buf_info,
