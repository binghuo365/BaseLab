...
template class ACE_Asynch_Acceptor<PSession>;
template class ACE_Asynch_Connector<PSession>;
template class ACE_Asynch_RW<ACE_Asynch_Read_Stream,ACE_Asynch_Write_Stream>;
template class ACE_Asynch_RW_Stream<ACE_Asynch_Read_Stream,ACE_Asynch_Write_Stream>;

#elif defined (ACE_HAS_TEMPLATE_INSTANTIATION_PRAGMA)

#pragma instantiate ACE_Asynch_Acceptor<PSession>
#pragma instantiate ACE_Asynch_Connector<PSession>
#pragma instantiate ACE_Asynch_RW<ACE_Asynch_Read_Stream,ACE_Asynch_Write_Stream>
#pragma instantiate ACE_Asynch_RW_Stream<ACE_Asynch_Read_Stream,ACE_Asynch_Write_Stream>
...
{
  {
    ...
    if (this->stream_.open (*this, 
      ...
      ACE_ERROR ((LM_ERROR,
                  ACE_TEXT ("(%t) %s %p\n"),
                  this->get_name(),
                  ACE_TEXT ("ACE_Asynch_RW_Stream::open")));
  ...
  if (nbytes == 0)
    {
      ...
      ACE_ERROR_RETURN((LM_ERROR,
         ACE_TEXT ("(%t) %s ACE_Asynch_Write_Stream::write 0 bytes\n"),
         this->get_name()),
         -1);
    }
...
void
Receiver::handle_user_operation(const ACE_Asynch_User_Result& result)
{
