 ...
 */
class TPROACTOR_Export TRB_Service_Handler : public TRB_Handler
{

  /// The Acceptor is the factory and therefore should have special
  /// privileges.
  // friend class TRB_Asynch_Acceptor<TRB_Service_Handler>;

public:
  /// A do nothing constructor.
  TRB_Service_Handler (void);

  /// Virtual destruction.
  virtual ~TRB_Service_Handler (void);
