...
ACE_RCSID(ace, Asynch_Acceptor2, "Asynch_Acceptor2.cpp,v 4.47 2002/10/05 00:25:52 shuston Exp")
...
TRB_Asynch_Acceptor2<HANDLER>::open (const ACE_INET_Addr &address,
                                         ...
                                         Guard_Monitor& guard)
{
  ...
  if (this->flg_cancel_ || this->listen_handle_ == ACE_INVALID_HANDLE)
    {
      return -1;
    }
...
TRB_Asynch_Acceptor2<HANDLER>::address_size (void)
{
