...
public :
    ...
    public:
        ...
        ACE_INET_Addr   remote_addr_;   // remote peer address
        ACE_INET_Addr   local_addr_;    // local address
...
public:
    ...
    void addresses (const ACE_INET_Addr & remote,
...
inline void
AsynchChannel::addresses (const ACE_INET_Addr & remote,
                          const ACE_INET_Addr & local)
{
...
inline const ACE_INET_Addr & 
AsynchChannel::remote_addr () const
{
    return this->info_.remote_addr_;
}

inline const ACE_INET_Addr & 
AsynchChannel::local_addr () const
{
    return this->info_.local_addr_;
}
